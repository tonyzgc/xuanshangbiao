...
### 问题8：右侧已选商标排序不符合直觉
- **原因**：已选商标按大类编号排序，但选择多个大类后需要手动寻找
- **修复**：实现基于选择时间的智能排序
  - 显示时：按"最近选择的大类"排序，最新选择的大类在最上面
  - 每个大类内部，按"最近选择的商品"排序，最新选择的在最上面
  - 复制和导出：按序号大小正序排列（大类从小到大，大类里面小类从小到大）
  - 添加 selectedAt 时间戳字段跟踪选择时间
  - 示例流程：
    1. 选08-080003、08-080123
    2. 选23-230122 → 23类移到最上面
    3. 再选08-080134 → 08类又回到最上面
    4. 在08类内部：080134最上面，然后080123、080003
